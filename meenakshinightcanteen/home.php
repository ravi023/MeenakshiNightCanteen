...
<body>
	<div id="menu">
		<h1><a href=""><b>Meenakshi Canteen</b></a></h1>
		<div >
			<ul style="font-size:16px; padding:6px 0px 0px 0px">
				<li><a href="#>echo $_SESSION['user'];</a></li><br />
	...
	<div id="cont">
		...
		This Website mainly focuses on online ordering of food with cash on delivery facility.
		Students of NIT-T can register on website once and then order the food from whichever hostel they want.
		Providers will provide them food in their hostel.
		</div>
	</div>	
