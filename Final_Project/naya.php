...
<body>
	<div id="menu">
		...
		$onoo = mysql_query('select * from order1 where RollNo = "'.$rno.'"') or die(mysql_error());
		
		$ono = mysql_result($onoo,mysql_num_rows($onoo)-1,'OrderNO');
		?>
	<div id="cont">
		...
		echo '<br />Order Details : <br /><br />';
		echo 'Order No : '.$ono.'<br />';
		echo 'Item Name '.' : '.'Quantity '.' - '.' Amount';
		for($j=1;$j<=24;$j++)
		{
			if(isset($i[$j]))
			{
		...
		echo '<br/><br/><br/>Your Order is taken successfully.<br />Thank You.';
		?>
		</p>
